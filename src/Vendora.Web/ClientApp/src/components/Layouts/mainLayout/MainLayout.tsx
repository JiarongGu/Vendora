      ...
      <Layout className={styles.container}>
        <Layout.Header className={styles.header}>
          <Menu theme={'light'} mode={'horizontal'} style={{ lineHeight: '60px' }}>
            <Menu.Item key={'1'} className={classnames(styles.logo, styles.menuItem)}>
              <Link to={'/'}>LOGO</Link>
            </Menu.Item>

            <Menu.Item key={'4'} className={styles.menuItem}>
              <Link to={'/user'}>
                <FontAwesomeIcon icon={faUserTie} />Talk to Expert
              </Link>
            </Menu.Item>
            ...
            <Menu.Item key={'2'} className={classnames('right', styles.menuItem)}>
              <Button className={styles.menuItemButton}>Login/Sign Up</Button>
            </Menu.Item>

            <Menu.Item key={'3'} className={classnames('right', styles.menuItem)}>
